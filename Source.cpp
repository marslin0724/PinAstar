...
void main()
{
	...
	*/
	...
	case A_Star_N_Section:
		Decoder = A_star_N_Section;
		break;
	case A_Star_5_Stack:
		Decoder = A_star_5_stack;
		break;
	case A_Star_6_Stack:
		Decoder = A_star_6_stack;
		break;
	case A_Star_7_Stack:
		Decoder = A_star_7_stack;
		break;
	case SPA_AvgLLR:
		Decoder = SPA_LLR;
		break;
	case A_Star_Rep:
		Decoder = A_star_repeatition;
		break;
	case A_Star_Section_MultiStack:
		Decoder = A_star_Section_Multistack;
		break;
	case SPA_AStar:
		Decoder = SPA_Astar;
		break;
	...
	case Brute_Force_AStar_ver2:
		Decoder = BF_A_star_ver2;
		break;
	case BF_AStar_interleaver:
		Decoder = BF_A_star_interleaver;
		break;
	case BF_AStar_interleaver_ver2:
		Decoder = BF_A_star_interleaver_ver2;
		break;
	case BF_SPA_AStar:
		Decoder = BF_SPA_A_star;
		break;
	case ABP_Decoder:
		Decoder = ABP;
		break;
	case BF_ABP_AStar:
		Decoder = BF_ABP_A_star;
		break;
	case ABP_AStar:
		Decoder = ABP_A_star;
		break;
	case AStar_Adaptive_i:
		Decoder = A_star_Adaptive_i;
		break;
	case RS_Hard_Desicion:
		Decoder = RS_Hard_desicion;
		break;
	case MRIP_BF_AStar:
		Decoder = MRIP_BF_A_star;
		break;
	case Subcode_MRIP_AStar:
		Decoder = Subcode_MRIP_A_star;
		break;
	case AStar_MultipleStack:
		Decoder = A_star_MultipleStack;
		break;
	case AStar_constraint_i_noComparison:
		Decoder = A_star_constraint_i_noComparison;
		break;
	case Subcode_AStar_AStar:
		Decoder = Subcode_A_star_A_star;
		break;
	case BF_SPA_BF_AStar:
		Decoder = BF_SPA_BF_A_star;
		break;
	case ABP_MRIP_AStar:
		Decoder = ABP_MRIP_A_star;
		break;
	case Subcode24_12_MRIP_AStar:
		Decoder = Subcode24_12_MRIP_A_star;
		break;
	case SISO_Path_AStar:
		Decoder = SISO_Path_A_star;
		break;
	case SISO_Path_AStar_CBC2_OSC:
		Decoder = SISO_Path_A_star_CBC2_OSC;
		break;
	case AStar_constraint_i_MinHeap:
		Decoder = A_star_constraint_i_Min_Heap;
		break;
	case SISO_Path_AStar_MinHeap:
		Decoder = SISO_Path_A_star_Min_Heap;
		break;
	case SISO_Path_AStar_Adaptive:
		Decoder = SISO_Path_A_star_Adaptive;
		break;
	case SISO_Path_AStar_MultiBase_Adaptive:
		Decoder = SISO_Path_A_star_MultiBase_Adaptive;
		break;
	case AStar_MultipleStack_SC:
		Decoder = A_star_MultipleStack_SC;
		break;
	case AStar_section_PC_MinHeap:
		Decoder = A_star_section_PC_MinHeap;
		break;
	case SISO_Path_AStar_Adaptive_MinHeap:
		Decoder = SISO_Path_A_star_Adaptive_Min_Heap;
		break;
